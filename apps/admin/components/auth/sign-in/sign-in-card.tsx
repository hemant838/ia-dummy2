...
export function SignInCard({
  ...
  return (
    <Card
      className={cn(
        'w-full px-4 py-2 border-transparent dark:border-border shadow-none',
        className
      )}
      {...other}
    >
      <CardHeader className="space-y-3">
        <CardTitle className="text-lg lg:text-[40px] leading-[150%]">
          Sign In
        </CardTitle>
        <CardDescription className="text-sm leading-[150%]">
